		...
		ColumnLayout{
			...
			MenuItemDelegate{
				...
				lefticon.source: Svg.fromString([
					...
					'<path opacity="0.4" d="M9.95745 10.3892C11.9042 10.3892 13.4652 8.81923 13.4652 6.86127C13.4652 4.90256 11.9042 3.33334 9.95745 3.33334C8.01069 3.33334 6.44971 4.90256 6.44971 6.86127C6.44971 8.81923 8.01069 10.3892 9.95745 10.3892Z" fill="#695EE7"/>',
					'<path opacity="0.4" d="M17.5733 7.68272C18.077 5.7015 16.6003 3.92215 14.72 3.92215C14.5155 3.92215 14.32 3.94466 14.129 3.98294C14.1036 3.98894 14.0753 4.0017 14.0603 4.02421C14.0432 4.05273 14.0559 4.091 14.0745 4.11577C14.6394 4.91276 14.964 5.88311 14.964 6.92475C14.964 7.92287 14.6662 8.85345 14.1439 9.62567C14.0902 9.70522 14.1379 9.81254 14.2327 9.82905C14.364 9.85231 14.4983 9.86432 14.6356 9.86807C16.0049 9.90409 17.2338 9.0178 17.5733 7.68272Z" fill="#695EE7"/>',
					'<path d="M19.0076 12.3475C18.7569 11.8101 18.1517 11.4417 17.2317 11.2608C16.7974 11.1542 15.6222 11.0041 14.5291 11.0244C14.5127 11.0267 14.5037 11.0379 14.5022 11.0454C14.5 11.0559 14.5045 11.0739 14.5261 11.0852C15.0313 11.3366 16.984 12.43 16.7385 14.7362C16.7281 14.836 16.8079 14.9223 16.9071 14.9073C17.3877 14.8383 18.6241 14.5711 19.0076 13.7388C19.2195 13.2991 19.2195 12.788 19.0076 12.3475Z" fill="#695EE7"/>',
					'<path opacity="0.4" d="M5.87057 3.98318C5.6803 3.94416 5.48406 3.92239 5.27961 3.92239C3.39926 3.92239 1.92259 5.70174 2.427 7.68297C2.76576 9.01804 3.9947 9.90434 5.36392 9.86832C5.50122 9.86456 5.63627 9.85181 5.76685 9.82929C5.86162 9.81278 5.90937 9.70547 5.85565 9.62592C5.33333 8.85294 5.03561 7.92311 5.03561 6.925C5.03561 5.8826 5.36094 4.91226 5.92579 4.11601C5.9437 4.09125 5.95713 4.05297 5.93922 4.02446C5.92429 4.00119 5.89669 3.98919 5.87057 3.98318Z" fill="#695EE7"/>',
					'<path d="M2.76788 11.2606C1.84786 11.4414 1.24346 11.8099 0.992746 12.3472C0.780087 12.7877 0.780087 13.2988 0.992746 13.7393C1.37628 14.5708 2.61268 14.8388 3.09321 14.9071C3.19245 14.9221 3.27155 14.8365 3.2611 14.7359C3.01561 12.4305 4.96833 11.3371 5.47424 11.0857C5.49513 11.0737 5.49961 11.0564 5.49737 11.0452C5.49588 11.0377 5.48767 11.0264 5.47125 11.0249C4.37737 11.0039 3.2029 11.154 2.76788 11.2606Z" fill="#695EE7"/>',
					'</svg>'])
				text: "Create Server"
			...
			HiddenContainer{
				...
				onShownChanged: {
					if (shown) client_form_container.shown = false
				}
			...
			MenuItemDelegate{
				...
				lefticon.source: Svg.fromString([
					...
					'<path d="M7.91675 12.5129C4.54527 12.5129 1.66675 13.052 1.66675 15.2055C1.66675 17.3582 4.52775 17.9167 7.91675 17.9167C11.2874 17.9167 14.1667 17.3777 14.1667 15.2241C14.1667 13.0705 11.3057 12.5129 7.91675 12.5129Z" fill="#695EE7"/>',
					'<path opacity="0.4" d="M7.91678 10.4619C10.2123 10.4619 12.0523 8.59809 12.0523 6.27302C12.0523 3.94796 10.2123 2.08334 7.91678 2.08334C5.6213 2.08334 3.78125 3.94796 3.78125 6.27302C3.78125 8.59809 5.6213 10.4619 7.91678 10.4619Z" fill="#695EE7"/>',
					'</svg>'])
				text: "Join Server"
				Layout.preferredHeight: 50
				Layout.fillWidth: true
			...
			HiddenContainer{
				...
				onShownChanged: {
					if (shown) server_password_container.shown = false
				}
			...
			MenuItemDelegate{
				...
				lefticon.source: Svg.fromString([
					...
					'<path opacity="0.4" d="M9.9974 10.4864C12.4457 10.4864 14.4074 8.52392 14.4074 6.07642C14.4074 3.62892 12.4457 1.66642 9.9974 1.66642C7.5499 1.66642 5.5874 3.62892 5.5874 6.07642C5.5874 8.52392 7.5499 10.4864 9.9974 10.4864" fill="#695EE7"/>',
					'</svg>'
				])
				text: "Hostname"
