...
BorderedRectangle {
	...
	RowLayout{
		...
		Rectangle{
			...
			RowLayout {
				...
				Label{
					text: Helper.truncate(String(Helper.filenameFromUrl(root.selectedFileUrl)), 20)
				...
				Image {
					source: Svg.fromString([
					   ...
					   `<path fill-rule="evenodd" clip-rule="evenodd" d="M4.29289 4.29289C3.90237 4.68342 3.90237 5.31658 4.29289 5.70711L5.70711 7.12132L4.2929 8.53553C3.90238 8.92606 3.90238 9.55922 4.2929 9.94975C4.68343 10.3403 5.31659 10.3403 5.70711 9.94975L7.12132 8.53554L8.53553 9.94975C8.92606 10.3403 9.55922 10.3403 9.94975 9.94975C10.3403 9.55922 10.3403 8.92606 9.94975 8.53553L8.53554 7.12132L9.94976 5.70711C10.3403 5.31658 10.3403 4.68342 9.94976 4.29289C9.55923 3.90237 8.92607 3.90237 8.53554 4.29289L7.12132 5.70711L5.70711 4.29289C5.31658 3.90237 4.68342 3.90237 4.29289 4.29289Z" fill="${theme.text}"/>`,
					   '</svg>'
					])
	...
	RowLayout {
		...
		Label {
			...
			color: theme.text
			text: {
				return Helper.digit(min_counter.count, 2) +
						":" + Helper.digit(sec_counter.count, 2)
			}
		}
