...
class MessageQueue(QObject):
	...
	def __init__(self, name: str = ""):
		...
		self.current = None
		self.name = name
		self.list: List[Union[str, QByteArray]] = []
	...
	def add(self, item: Union[str, QByteArray]):
	...
	def reverse_pop(self):
		...
		the item in the stack is "somehow" remove before it is added, and it triggered some sneaky
		errors. the behavior might be traced back to Qt's Signal design or my tangled code.
