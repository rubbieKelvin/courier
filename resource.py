...
qsTr(\x22Peers (5)\x22\
)\x0a\x09\x09\x09\x09\x09font.poin\
tSize: 12\x0a\x09\x09\x09\x09\x09L\
ayout.alignment:\
 Qt.AlignLeft | \
Qt.AlignTop\x0a\x09\x09\x09\x09\
}\x0a\x09\x09\x09\x09ScrollView\
 {\x0a\x09\x09\x09\x09\x09Layout.f\
illHeight: true\x0a\
...
ontal.policy: Sc\
rollBar.AlwaysOf\
f\x0a\x09\x09\x09\x09\x09ScrollBar\
.vertical.policy\
: ScrollBar.AsNe\
eded\x0a\x0a\x09\x09\x09\x09\x09ListV\
iew {\x0a\x09\x09\x09\x09\x09\x09id: \
peer_list_view\x0a\x09\
\x09\x09\x09\x09\x09spacing: 3\x0a\
\x09\x09\x09\x09\x09\x09clip: true\
\x0a\x09\x09\x09\x09\x09\x09delegate:\
 Rectangle {\x0a\x09\x09\x09\
\x09\x09\x09\x09height: 40\x0a\x09\
\x09\x09\x09\x09\x09\x09width: (pa\
rent || {\x0a\x09\x09\x09\x09\x09\x09\
\x09\x09\x09\x09\x22width\x22: 0\x0a\x09\
\x09\x09\x09\x09\x09\x09\x09\x09}).width\
\x0a\x09\x09\x09\x09\x09\x09\x09clip: tr\
ue\x0a\x09\x09\x09\x09\x09\x09\x09color:\
 \x22transparent\x22\x0a\x0a\
\x09\x09\x09\x09\x09\x09\x09RowLayout\
 {\x0a\x09\x09\x09\x09\x09\x09\x09\x09ancho\
rs.fill: parent\x0a\
\x09\x09\x09\x09\x09\x09\x09\x09anchors.\
margins: 5\x0a\x0a\x09\x09\x09\x09\
\x09\x09\x09\x09Rectangle {\x0a\
\x09\x09\x09\x09\x09\x09\x09\x09\x09id: rec\
tangle\x0a\x09\x09\x09\x09\x09\x09\x09\x09\x09\
width: height\x0a\x09\x09\
\x09\x09\x09\x09\x09\x09\x09height: p\
arent.height\x0a\x09\x09\x09\
\x09\x09\x09\x09\x09\x09color: \x22#c\
4c4c4\x22\x0a\x09\x09\x09\x09\x09\x09\x09\x09\x09\
radius: width / \
2\x0a\x09\x09\x09\x09\x09\x09\x09\x09}\x0a\x0a\x09\x09\x09\
\x09\x09\x09\x09\x09Label {\x0a\x09\x09\x09\
\x09\x09\x09\x09\x09\x09height: pa\
rent.height\x0a\x09\x09\x09\x09\
\x09\x09\x09\x09\x09text: name\x0a\
\x09\x09\x09\x09\x09\x09\x09\x09\x09font.pi\
xelSize: 11\x0a\x09\x09\x09\x09\
\x09\x09\x09\x09\x09Layout.fill\
Width: true\x0a\x09\x09\x09\x09\
\x09\x09\x09\x09}\x0a\x09\x09\x09\x09\x09\x09\x09}\x0a\x09\
\x09\x09\x09\x09\x09}\x0a\x09\x09\x09\x09\x09\x09mod\
el: statemanager\
_.peermodel\x0a\x09\x09\x09\x09\
\x09}\x0a\x09\x09\x09\x09}\x0a\x09\x09\x09}\x0a\x09\x09\
}\x0a\x0a\x09\x09StackLayout\
 {\x0a\x09\x09\x09id: chat_s\
tack\x0a\x09\x09\x09width: 1\
00\x0a\x09\x09\x09height: 10\
0\x0a\x09\x09\x09Layout.fill\
Height: true\x0a\x09\x09\x09\
Layout.fillWidth\
: true\x0a\x0a\x09\x09\x09Repea\
ter {\x0a\x09\x09\x09\x09model:\
 statemanager_.p\
eermodel\x0a\x09\x09\x09\x09del\
egate: ChatPage \
...
signal handshake\
Done(bool succes\
sful)\x0a\x0a\x09function\
 createServer(pa\
ssword) {\x0a\x09\x09serv\
er.set_password(\
password)\x0a\x09\x09if (\
server.run()) {\x0a\
\x09\x09\x09// create cli\
ent\x0a\x09\x09\x09client.co\
nnect_to(\x22:self\x22\
)\x0a\x0a\x09\x09\x09if (passwo\
rd.length > 0) {\
\x0a\x09\x09\x09\x09waitingForA\
uth = true\x0a\x09\x09\x09} \
else {\x0a\x09\x09\x09\x09hands\
hakeDone(true)\x0a\x09\
\x09\x09}\x0a\x09\x09\x09return tr\
ue\x0a\x09\x09} else {\x0a\x09\x09\
\x09return false\x0a\x09\x09\
}\x0a\x09}\x0a\x0a\x09function \
connectToServer(\
hostname){\x0a\x09\x09cli\
ent.connect_to(h\
ostname)\x0a\x09\x09waiti\
ngForAuth = true\
\x0a\x09}\x0a\x0a\x09readonly p\
roperty list<Con\
nections> connec\
tions: [\x0a\x09\x09Conne\
ctions {\x0a\x09\x09\x09targ\
et: client\x0a\x09\x09\x09fu\
nction onHandsha\
keReceived(messa\
...
ssage.body===\x22$a\
uth\x22){\x0a\x09\x09\x09\x09\x09\x09req\
uireAuth()\x0a\x09\x09\x09\x09\x09\
}else if (messag\
e.body===\x22$succe\
ssfull\x22 || messa\
ge.body===\x22$no-a\
uth\x22){\x0a\x09\x09\x09\x09\x09\x09roo\
t.waitingForAuth\
 = false\x0a\x09\x09\x09\x09\x09\x09h\
andshakeDone(tru\
e)\x0a\x09\x09\x09\x09\x09}else{\x0a\x09\
\x09\x09\x09\x09\x09handshakeDo\
ne(false)\x0a\x09\x09\x09\x09\x09}\
...
\x00\x00\x00\x00\x00\x00\x00\x00\
\x00\x00\x00\xac\x00\x00\x00\x00\x00\x01\x00\x00!\xe9\
\x00\x00\x01zQ\x9f0\x08\
\x00\x00\x00j\x00\x00\x00\x00\x00\x01\x00\x00\x17\xc9\
\x00\x00\x01zQ\xe1u\x1e\
\x00\x00\x00\x22\x00\x00\x00\x00\x00\x01\x00\x00\x08\xe1\
\x00\x00\x01zQ\xe1\x95,\
\x00\x00\x00\xc2\x00\x01\x00\x00\x00\x01\x00\x00#U\
\x00\x00\x01zP\xe4I\xe1\
\x00\x00\x00\xe4\x00\x00\x00\x00\x00\x01\x00\x00%5\
\x00\x00\x01zQ\xd5\x0e/\
\x00\x00\x01\x0a\x00\x00\x00\x00\x00\x01\x00\x00)O\
\x00\x00\x01zQE\xdbT\
"
